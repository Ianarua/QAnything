export default {
  ...
  common: {
    ...
    click: '点击上传',
    close: '关闭',
    updesc1: '支持文件格式md、txt、pdf、jpg、png、jpeg、docx、xlsx、pptx、eml、csv',
    updesc2: '可批量上传，支持文件格式md、txt、pdf、jpg、png、jpeg、docx、xlsx、pptx、eml、csv',
    confirm: '确定',
    confirm2: '确认',
